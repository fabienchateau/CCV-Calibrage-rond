...
public class TuioMouse implements TuioListener {
	...
	public void addTuioCursor(TuioCursor tcur) {
		...
		if (mouse<0) {
			...
			if (robot!=null) robot.mouseMove(tcur.getScreenX(width),tcur.getScreenY(height));
		   System.out.println("Move : "+tcur.getScreenX(width)+"x"+tcur.getScreenY(height));
		} else {
	...
	public TuioMouse() {
		...
		System.out.println("Mouse robot initialized on screen " + width + "x" + height);
		if(robot==null) System.out.println("failed to initialize mouse robot");
