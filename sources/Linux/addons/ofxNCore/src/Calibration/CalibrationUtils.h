...
class CalibrationUtils
{
	public:
        ...
        bool isOnEdge(float x, float y, float xa, float ya, int iA, float xb, float yb, int iB, int* pointA, int* pointB, float* K);
        ...
        void findTriangleWithin(vector2df pt, triangle* t, triangle* ts);
	...
	private:
		...
		//!
		string				message;
		//! DEBUG : valeur differente suivant la zonne
		int type_point;
};
#endif
