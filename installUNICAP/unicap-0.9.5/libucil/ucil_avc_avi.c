...
//
//
ucil_avcavi_video_file_object_t *ucil_avcavi_create_video_file( const char *path, unicap_format_t *format, va_list ap )
{
   guint n_parameters;
   ...
   vobj = ucil_avcavi_create_video_filev( path, format, n_parameters, parameters );
   g_free( parameters );
   return vobj;
}

ucil_avcavi_video_file_object_t *ucil_avcavi_create_video_filev( const char *path, unicap_format_t *format, guint n_parameters, GParameter *parameters )
{
